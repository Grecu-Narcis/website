...
/**
 * Logotip + simbolul monedei. Glifa este un „f” stilizat, bătut ca o monedă de florin.
 * `onDark` inversează culorile textului pentru footer și pentru secțiunile întunecate.
 */
