...
/**
 * One button, four looks. Renders an <a> when `href` is given, otherwise a
 * <button> — so semantics stay correct without a second component.
 *
 * Variants: primary (gold CTA) · dark (brand fill) · outline · ghost
 */
...
export default function Button({
  ...
  // The arrow nudges on hover — a small affordance that reads as "forward".
  const glyph = icon ? (
    <Icon
      name={icon}
