...
/**
 * Bloc comun de supratitlu + titlu + introducere, ca toate secțiunile să aibă același ritm.
 *
 * @param {'left'|'center'} align
 * @param {boolean} onDark  inversează culorile pentru secțiunile pe fundal închis
 */
