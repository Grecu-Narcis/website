...
/**
 * Review grid. Stacks on mobile, 3-up from `lg`.
 * Each card carries a measurable outcome chip — the detail that makes a
 * testimonial persuasive rather than decorative.
 */
      ...
      <div className="container-page">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <SectionHeading
            ...
            accent="not the adjectives"
            lead="Every review below is tied to a completed file. We publish the outcome, the product and the city."
            className="lg:mx-0"
          />
          ...
          <Reveal delay={100} className="shrink-0">
            <div className="flex items-center gap-4 rounded-2xl border border-ink-200/70 bg-ink-50/70 px-5 py-4">
              <div>
                ...
                <p className="mt-1.5 text-sm font-bold text-brand-950">4.9 out of 5</p>
                <p className="text-xs text-ink-500">380 verified reviews</p>
              </div>
