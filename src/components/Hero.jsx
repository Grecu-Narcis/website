...
/**
 * Above-the-fold: value proposition, dual CTA, trust bullets, and a photo
 * with two floating cards layered over it (approval proof + rating).
 *
 * Layout: single column on mobile, 12-col split from `lg` up.
 */
export default function Hero() {
  return (
    <section id="top" className="relative overflow-hidden pt-28 pb-16 sm:pt-32 lg:pt-40 lg:pb-24">
      {/* ---------- Background: soft gradient field + subtle grid ---------- */}
      ...
      <div className="container-page grid items-center gap-12 lg:grid-cols-12 lg:gap-8">
        ...
        <div className="lg:col-span-6 xl:col-span-6">
          ...
          <Reveal delay={80}>
            <h1 className="text-display mt-6">
              ...
              <span className="relative inline-block">
                ...
                {/* Hand-drawn style underline behind the accent phrase */}
                <svg
                  viewBox="0 0 300 12"
          ...
          {/* Compact contact line — useful on mobile where the top bar is hidden */}
          <Reveal delay={360}>
        ...
        <div className="lg:col-span-6 xl:col-span-6">
          <Reveal delay={180} className="relative mx-auto max-w-lg lg:max-w-none">
            ...
            <div className="relative aspect-4/5 overflow-hidden rounded-[2rem] bg-brand-100 shadow-lift sm:aspect-square lg:aspect-4/5">
              <img
                src={images.hero}
                alt="A family home lit from within at dusk"
                loading="eager"
                fetchPriority="high"
                className="size-full object-cover"
              />
              {/* Tint so white cards stay legible over any photo */}
              <div className="absolute inset-0 bg-gradient-to-tr from-brand-950/45 via-brand-950/5 to-transparent" />
            </div>

            {/* Floating: approval proof */}
            ...
            <div className="absolute -top-4 right-2 rounded-2xl border border-white/60 bg-white/95 px-4 py-3 shadow-card backdrop-blur-xl sm:right-0">
              ...
              <p className="mt-1.5 text-xs font-semibold text-brand-950">
                4.9 / 5 <span className="font-normal text-ink-500">· 380 reviews</span>
              </p>
            </div>
          </Reveal>
        </div>
